...
function cuadrado (){
    var a=0;
    var elv=0;
    a = parseInt(prompt("Digite el número del cual desea saber el cuadrado: "));
    elv=a*a;
...
function metros_centimetros(){
    var m=0;
    var cm=0;
    m = parseFloat(prompt("Digite los metros que desea convertir a centimetros: "));
cm = m*100/1.0;
...
function determinar_edad (){
    var año=0;
    var edad = 0;
año = parseInt(prompt("Digite el año de nacimiento"));
edad = 2022 - año;
...
cap= parseInt(prompt("Digite su capital"));
ganancia= 2*c/100;
alert("Las ganancias por mes es de: " + ganancia);
año = parseInt(prompt("Digite el año en meses que desea invertir el dinero: "));
gantol=gan*año
...
function colegio(){
    ...
    a = parseFloat(prompt("Digite la primera nota: "));
    b = parseFloat(prompt("Digite la segunda nota: "));
    c = parseFloat(prompt("Digite la tercera nota: "));
    d = parseFloat(prompt("Digite la cuarta nota: "));
    e = parseFloat(prompt("Digite la quinta nota: "));
    suma = a+b+c+d+e;
...
function fruteria(){
    ...
    k=parseInt(prompt("Digite los kilos comprados"));
    t=4500*k;
    if(k<=2){
        alert("Ups! No tiene descuento");
